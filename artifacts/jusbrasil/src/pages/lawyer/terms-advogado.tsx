      ...
      <div className="pt-24 pb-32 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <article className="rounded-2xl border border-border bg-card/50 shadow-sm p-6 sm:p-10 text-foreground text-sm sm:text-[15px] leading-relaxed space-y-8">
            ...
            <section className="space-y-3">
              <h2 className="text-lg font-bold text-[#001532]">6. Privacidade e Dados</h2>
              <p>
                Os dados dos clientes acessados através da plataforma são de uso exclusivo para a prestação do serviço
                contratado, em conformidade com a Lei Geral de Proteção de Dados (LGPD).
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-[#001532]">7. Alterações</h2>
              <p>
