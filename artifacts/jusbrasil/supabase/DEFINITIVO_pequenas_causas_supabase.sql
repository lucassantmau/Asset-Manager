...
COMMENT ON COLUMN public.pequenas_causas_submissions.disponivel_para_advogados IS 'true após envio do formulário — caso entra no pool para advogados aprovados';
COMMENT ON COLUMN public.pequenas_causas_submissions.assigned_lawyer_id IS 'Advogado que assumiu o caso (id = auth.users)';
COMMENT ON COLUMN public.pequenas_causas_submissions.accepted_proposal_id IS 'Proposta escolhida pelo cliente';
COMMENT ON COLUMN public.pequenas_causas_submissions.formulario_enviado_em IS 'Timestamp do envio do formulário pelo cliente';
...
-- -----------------------------------------------------------------------------
-- 7) Regra de negócio: 1 formulário enviado por pagamento confirmado
-- -----------------------------------------------------------------------------
...
-- RLS: pool / assumir caso (depende de lawyer_profiles)
